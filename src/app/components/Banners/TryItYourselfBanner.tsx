  ...
  return (
    <section className="bg-black py-12">
      <div className="px-6 text-white">
        <div className="border-white/20 pt-4 text-6xl uppercase md:border-t md:text-4xl md:normal-case">
          Try it Yourself
        </div>
        <div className="relative left-[calc(-50vw+50%)] w-[100vw] md:static md:left-auto md:w-auto">
          <div className="mt-6 rounded-[32px] bg-white p-6 text-black lg:rounded-[48px]">
            <div className="my-4 flex flex-col gap-x-4 text-nowrap md:flex-row md:items-center">
              <div className="mb-3 text-sm md:mb-0">Generate text in</div>
              <div className="flex w-full gap-x-4 overflow-x-auto md:ml-3">
            ...
            <div className="mt-6 flex flex-col justify-between md:flex-row">
              <div className="max-h-[60vh] overflow-y-scroll md:max-w-[600px]">
                <div className="text-lg">
                  ...
                  Today, 30 million people use Speechify to read 3x faster, remember 2x more &
                  reduce their stress. <br /> <br />
